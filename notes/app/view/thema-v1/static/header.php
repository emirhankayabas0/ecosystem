...
<head>
    ...
    <!-- Icon -->
    <link rel="apple-touch-icon" sizes="57x57" href="<?= public_url("images/note.png") ?>">
    <link rel="apple-touch-icon" sizes="60x60" href="<?= public_url("images/note.png") ?>">
    <link rel="apple-touch-icon" sizes="72x72" href="<?= public_url("images/note.png") ?>">
    <link rel="apple-touch-icon" sizes="76x76" href="<?= public_url("images/note.png") ?>">
    <link rel="apple-touch-icon" sizes="114x114" href="<?= public_url("images/note.png") ?>">
    <link rel="apple-touch-icon" sizes="120x120" href="<?= public_url("images/note.png") ?>">
    <link rel="apple-touch-icon" sizes="144x144" href="<?= public_url("images/note.png") ?>">
    <link rel="apple-touch-icon" sizes="152x152" href="<?= public_url("images/note.png") ?>">
    <link rel="apple-touch-icon" sizes="180x180" href="<?= public_url("images/note.png") ?>">
    <link rel="icon" type="image/png" sizes="192x192" href="<?= public_url("images/note.png") ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= public_url("images/note.png") ?>">
    <link rel="icon" type="image/png" sizes="96x96" href="<?= public_url("images/note.png") ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= public_url("images/note.png") ?>">
    <!-- Script -->
    <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
    <script>
        let api = "<?= site_url("ajax") ?>";
    </script>
</head>
...
<body>
    <header class="header">
        <nav class="nav">
            <div class="start">
                <div class="menu" onclick="openMenu()"><span class="icon"><?= ListBar(24) ?></span></div>
                <a href="<?= site_url() ?>" class="brand">
                    <img src="<?= public_url("images/note.png") ?>" class="hide-768px" alt="">
                    <span>Not</span>
                </a>
            </div>
            <div class="center hide-768px">
                <div class="field">
                    ...
                    <input type="text" id="searchInput" class="search" placeholder="Arama yapın">
                ...
                <div class="accounts">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="accountInside">
                        ...
                        <div class="accountsContent content">
                            ...
                            <a href="http://localhost/auth/signin?service=memento&continue=http://localhost/notes/&hl=tr" target="_blank" class="addSession">
