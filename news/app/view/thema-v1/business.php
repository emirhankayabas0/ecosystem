...
<main class="main">
    <div class="news">
        ...
        <div class="container d-flex">
            <div class="content">
                <h1>
                    <div class="business"><img src="<?= public_url("images/business.webp") ?>" alt=""></div>
                    <script>
                        if (localStorage.getItem("key") == "us") {
                            document.write("Business")
                        } else {
                            document.write("İşletme")
                        }
                    </script>
                </h1>
            </div>
...
<script>
    document.title = "Habeler - İşletme - En yeni";
    if (typeof localStorage.getItem("key") == 'undefined' || localStorage.getItem("key") == null) {
        news("business", coun);
    } else {
        news("business", localStorage.getItem("key"));
    }
</script>