...
<head>
    ...
    <script>var api_url = '<?=admin_url('api')?>';</script>
    <script src="<?php echo admin_public_url('scripts/admin.js') ?>"></script>
    <script src="<?php echo admin_public_url('scripts/api.js') ?>"></script>

    <link rel="icon" type="image/png" sizes="192x192" href="<?= admin_public_url("images/favicon.png") ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= admin_public_url("images/favicon.png") ?>">
    <link rel="icon" type="image/png" sizes="96x96" href="<?= admin_public_url("images/favicon.png") ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= admin_public_url("images/favicon.png") ?>">
    <style>
