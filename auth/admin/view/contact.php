                ...
                <tr>
                    <td>
                        <?php if ($row['contact_read'] == 1) : ?>
                            <div style="background-color: green; color: #fff; text-align: center; padding: 3px 6px; border-radius: 3px;">Okundu</div>
                        <?php else : ?>
                            <div style="background-color: darkred; color: #fff; text-align: center; padding: 3px 6px; border-radius: 3px;">Okunmadı</div>
                        <?php endif; ?>
                    </td>
                    <td>
                    ...
                    <td class="hide">
                        ...
                        <?php if ($row['contact_read_date']) : ?>
                            <div style="color: #999; font-size: 12px;"><?= timeConvert($row['contact_read_date']) ?> okundu</div>
                            <div style="color: #999; font-size: 12px;"><strong>Okuyan: </strong><?= $row['user_name'] ?></div>
                        <?php endif; ?>
                    </td>
                    <td>
...
<script>
    document.title = "İletişim | Emirhan Kayabaş Admin";
</script>