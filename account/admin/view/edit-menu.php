...
<div class="box- menu-container">
    ...
    <form action="" method="post">
        <div style="padding-bottom: 10px; max-width: 400px">
            <input type="text" name="menu_title" value="<?= post("menu_title") ? post('menu_title') : $row['menu_title'] ?>" placeholder="Menü Adı">
        </div>
...
<script>
    document.title = "Menü Düzenle | Emirhan Kayabaş Admin";
</script>