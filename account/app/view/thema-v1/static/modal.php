            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <img id="feedback_image" class="d-none" src="<?= public_url("images/screenshot.png") ?>" alt="feedback_image">
...
<article class="modalZoomUserImage">
    <h1 class="name"><?= $user["user_name"] . " " . $user["user_surname"] ?></h1>
    <div class="close" onclick="zoomUserImageClose()"><?= close(24) ?></div>
    <a href="<?= $user["user_image"] ?>" class="download" download><?= download(24) ?></a>
    <div class="userImage">
        <figure>
            <img src="<?= $user["user_image"] ?>" alt="" class="image">
        </figure>
    </div>
</article>
